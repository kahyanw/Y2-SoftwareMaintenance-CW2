...
public class PlayState extends GameState {
	...
	private static int yAxe;
	private static int xBoat;
	private static int yBoat;
...
//		tileMap.loadMap("/Maps/testmap.map");
	...
	private void populateDiamonds() {
	 ...
	 public void loadItems (String itemmap) {
		 try {
			BufferedReader br = new BufferedReader(new FileReader(itemmap));
